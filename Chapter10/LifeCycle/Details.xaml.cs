    ...
    public sealed partial class Details : Page
    {
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            if (e.NavigationParameter != null)
            {
                ...
                {
                    ItemTitle.Text = "Add a new item...";
                }
                if (e.PageState != null && e.PageState["ItemTitle"] != null)
                {
                    ItemTitle.Text = e.PageState["ItemTitle"] as string;
                }
        ...
        {
            e.PageState["ItemTitle"] = ItemTitle.Text;
        }
